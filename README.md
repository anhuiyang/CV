...
| [Event Planner](https://github.com/anhuiyang/event_planner_app)               | A single page Vanilla **JavaScript** event planning app with **local storage** deployed on surge. **TDD** with a [self-made testing framework](https://github.com/anhuiyang/casi_test_framework_js).                                                                                                                                         |
